...
var _bookSlider = __webpack_require__(11);

var _bookSlider2 = _interopRequireDefault(_bookSlider);

var _catalogSlider = __webpack_require__(13);

var _catalogSlider2 = _interopRequireDefault(_catalogSlider);
...
var bookSlider = new _swiper2.default('.book__slider-wrap', {
  slidesPerView: 2,
  spaceBetween: 2,
  slidesPerGroup: 2,
  navigation: {
...
var catalogSlider = new _swiper2.default('.catalog__slider-container', {
  init: false,
  slidesPerView: 4,
  spaceBetween: 30,
  breakpoints: {
...
function setEvent() {
  if (checkWindowWidth() <= 576) {
    var items = document.querySelectorAll('.catalog__item.swiper-slide');

    for (var i = 0; i < items.length; i++) {
      items[i].removeEventListener('click', nextSlide);
      items[i].removeEventListener('click', prevSlide);
    }
    var nextBtn = document.querySelector('.catalog__item.swiper-slide-next');
    var prevBtn = document.querySelector('.catalog__item.swiper-slide-prev');
